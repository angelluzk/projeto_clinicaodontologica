...
<body>
    ...
    <main>
        ...
        $sql = "INSERT INTO estoque(produto_id, quantidade, data_entrada) 
                    VALUES('$produto_id','$quantidade','$data_entrada')";
        $con = mysqli_connect("127.0.0.1", "root", "", "clinicaodontologica");
        if (mysqli_connect_errno()) {
            echo "Failed to connect to MySQL:" . mysqli_connect_error();
        }
        mysqli_query($con, $sql);
        echo "<div class='mensagem-sucesso'>Estoque cadastrado com sucesso!</div>";
        mysqli_close($con);
        ?>
