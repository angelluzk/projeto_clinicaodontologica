...
<body>
    ...
    <h1>Lista de Estoque - ALTERAR/DELETAR</h1>
    <div>
        <form method="GET" action="listar_estoque.php">
            <input type="text" name="search" placeholder="Buscar por ID do Produto" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
        ...
        <table>
            ...
            if (!empty($search)) {
                $sql .= " WHERE produto_id LIKE '%$search%'";
            }
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form action="realizadelestoque.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-del" type="submit" name="botdelestoque" value="ok">Del</button>
                        </form>
                    </td>
                    <td>
                        <form action="formaltestoque.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-alt" type="submit" name="botaltestoque" value="ok">Alt</button>
                        </form>
                    </td>
                </tr>
            <?php }
