...
<body>
    ...
    <div class="form-container">
        ...
        $result = mysqli_query($con, "SELECT * FROM medicos WHERE id='$id'");
        ?>
        <h1>Cadastro de Médico</h1>
        <form action="realizaaltmedico.php" method="POST">
            <?php while ($row = mysqli_fetch_array($result)) { ?>
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="especialidade" name="especialidade" value="<?php echo $row['especialidade']; ?>" required>
                </div>
                <div class="form-row">
                    <label for="crm">CRM:</label>
                    <input type="text" id="crm" name="crm" value="<?php echo $row['crm']; ?>" required>
                </div>
                <div class="form-row">
