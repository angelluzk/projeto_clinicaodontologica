...
<body>
    ...
    <?php
        ...
        $sql = "update produtos set id='$id',nome='$nome',descricao='$descricao',preco='$preco',quantidade='$quantidade' where id=$id";
        ...
        mysqli_close($con);
        ?>
        <h2 class="botao-alterar"><a id="voltar-link" href="listar_produto.php">VOLTAR</a></h2>
    </main>    
    <footer>
