...
<body>
    ...
    <?php
        ...
        $sql = "INSERT INTO pacientes(nome, data_nascimento, telefone, email, endereco) 
        ...
        echo "<div class='mensagem-sucesso'>Paciente cadastrado com sucesso!</div>";
        mysqli_close($con);
        ?>
        <h2 class="botao-alterar"><a id="voltar-link" href="cadastro_paciente.html">VOLTAR</a></h2>        
    </main>    
    <footer>
