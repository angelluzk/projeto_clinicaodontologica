...
<body>
    ...
    <h1>Lista de Produtos - ALTERAR/DELETAR</h1>
    <div>
        <form method="GET" action="listar_produto.php">
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form action="realizadelproduto.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-del" type="submit" name="botdelproduto" value="ok">Del</button>
                        </form>
                    </td>
                    <td>
                        <form action="formaltproduto.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-alt" type="submit" name="botaltproduto" value="ok">Alt</button>
                        </form>
                    </td>
                </tr>
            <?php }
