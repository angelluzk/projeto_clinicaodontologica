...
<body>
    ...
    <?php
        ...
        $sql = "update funcionarios set id='$id',nome='$nome',cargo='$cargo',data_admissao='$data_admissao',telefone='$telefone',email='$email',endereco='$endereco' where id=$id";
        $con = mysqli_connect("127.0.0.1", "root", "", "clinicaodontologica");
        if (mysqli_connect_errno()) {
            echo "Failed to connect to MySQL: " . mysqli_connect_error();
        }
        mysqli_query($con, $sql);
        echo "<div class='mensagem-sucesso'>Funcionário alterado com sucesso!</div>";
        mysqli_close($con);
        ?>
        <h2 class="botao-alterar"><a id="voltar-link" href="listar_funcionario.php">VOLTAR</a></h2>
    </main>    
    <footer>
