...
<body>
    ...
    <?php
        ...
        $sql = "INSERT INTO funcionarios(nome, cargo, data_admissao, telefone, email, endereco) 
                    VALUES('$nome','$cargo','$data_admissao','$telefone','$email','$endereco')";
        $con = mysqli_connect("127.0.0.1", "root", "", "clinicaodontologica");
        if (mysqli_connect_errno()) {
            echo "Failed to connect to MySQL:" . mysqli_connect_error();
        }
        mysqli_query($con, $sql);
        echo "<div class='mensagem-sucesso'>Funcionário cadastrado com sucesso!</div>";
        mysqli_close($con);
        ?>
