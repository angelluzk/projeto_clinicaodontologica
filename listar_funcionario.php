...
<body>
    ...
    <div>
        <form method="GET" action="listar_funcionario.php">
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form action="realizadelfuncionario.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-del" type="submit" name="botdelfuncionario" value="ok">Del</button>
                        </form>
                    </td>
                    <td>
                        <form action="formaltfuncionario.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-alt" type="submit" name="botaltfuncionario" value="ok">Alt</button>
                        </form>
                    </td>
                </tr>
            <?php }
