...
<body>
    ...
    <h1>Lista de Pacientes - ALTERAR/DELETAR</h1>
    <div>
        <form method="GET" action="listar_paciente.php">
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form action="realizadelpaciente.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-del" type="submit" name="botdelpaciente" value="ok">Del</button>
                        </form>
                    </td>
                    <td>
                        <form action="formaltpaciente.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                            <button class="botao-alt" type="submit" name="botaltpaciente" value="ok">Alt</button>
                        </form>
                    </td>
                </tr>
            <?php }
