...
<body>
    ...
    <?php
        ...
        $sql = "update estoque set id='$id',produto_id='$produto_id',quantidade='$quantidade',data_entrada='$data_entrada' where id=$id";
        $con = mysqli_connect("127.0.0.1", "root", "", "clinicaodontologica");
        if (mysqli_connect_errno()) {
            echo "Failed to connect to MySQL: " . mysqli_connect_error();
        }
        mysqli_query($con, $sql);
        echo "<div class='mensagem-sucesso'>Estoque alterado com sucesso!</div>";
        mysqli_close($con);
        ?>
        <h2 class="botao-alterar"><a id="voltar-link" href="listar_estoque.php">VOLTAR</a></h2>        
    </main>    
    <footer>
